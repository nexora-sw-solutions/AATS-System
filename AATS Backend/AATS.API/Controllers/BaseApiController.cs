...
namespace AATS.API.Controllers
{
    ...
    public abstract class BaseApiController<T> : ControllerBase where T : class
    {
        ...
        [HttpGet]
        public virtual async Task<ActionResult<ApiResponse<PaginatedResult<T>>>> GetAll([FromQuery] bool enrich = true)
        {
            var list = await _repository.GetAllAsync();
            var filtered = await FilterListForCurrentUserAsync(list);
