...
namespace AATS.API.Controllers
{
    public class UsersController : BaseApiController<User>
    {
        ...
        public override async Task<ActionResult<ApiResponse<PaginatedResult<User>>>> GetAll([FromQuery] bool enrich = true, [FromQuery] bool includeDeleted = false)
        {
    ...
    public class BranchesController : BaseApiController<Branch>
    {
        ...
        public override async Task<ActionResult<ApiResponse<PaginatedResult<Branch>>>> GetAll([FromQuery] bool enrich = true, [FromQuery] bool includeDeleted = false)
        {
