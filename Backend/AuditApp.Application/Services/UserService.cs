...
public class UserService : IUserService
{
    ...
    {
        var query = _db.Users.Include(u => u.Branch).Where(u => !u.IsDeleted).AsQueryable();
    ...
    {
        var user = await _db.Users.Include(u => u.Branch).FirstOrDefaultAsync(u => u.Id == id && !u.IsDeleted, ct);
