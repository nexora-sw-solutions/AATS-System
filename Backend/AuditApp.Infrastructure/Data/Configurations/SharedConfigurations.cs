...
public class NexoraServiceRequestConfiguration : IEntityTypeConfiguration<NexoraServiceRequest>
{
    public void Configure(EntityTypeBuilder<NexoraServiceRequest> builder)
    {
        ...
        builder.Property(e => e.Id).HasColumnName("Id");
        builder.Property(e => e.RequestDate).HasColumnName("RequestDate").IsRequired();
        builder.Property(e => e.ClientId).HasColumnName("ClientId");
        builder.Property(e => e.ClientName).HasColumnName("ClientName").HasMaxLength(255).IsRequired();
        builder.Property(e => e.CompanyName).HasColumnName("CompanyName").HasMaxLength(255);
