...
public partial class ForensicAuditViewModel : AuditTableViewModelBase
{
    public override string PageTitle => "Forensic Audit";
    public override string SearchPlaceholder => "Search Client, Assignment, ID...";
    public override string StatusHeader => "Status";
    public override string GuideLinkText => "Learn more about Forensic Audit & Investigation";

    public ForensicAuditViewModel()
    {
