...
public partial class TaxAccountAddRecordView : UserControl
{
    public TaxAccountAddRecordView()
    {
        InitializeComponent();
    }
    ...
    protected override void OnAttachedToVisualTree(Avalonia.VisualTreeAttachmentEventArgs e)
    {
        ...
        if (DataContext is ViewModels.AuditAndAccounts.TaxAccountAddRecordViewModel vm)
        {
            ...
            vm.RequestFilePicker = async () =>
            {
                ...
                var files = await topLevel.StorageProvider.OpenFilePickerAsync(new Avalonia.Platform.Storage.FilePickerOpenOptions
                {
                    Title = "Select Tax Account Documents",
                    AllowMultiple = true
                });
