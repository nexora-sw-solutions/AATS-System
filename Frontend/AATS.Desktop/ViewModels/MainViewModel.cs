...
public partial class MainViewModel : ViewModelBase
{
    ...
    private void ConfirmSignOut()
    {
        ...
        LogService.Instance.AddLog("Logout", "Auth", "Central", $"User '{CurrentUser.Username}' signed out successfully.");
    ...
    private async Task UpdateProfile()
    {
        ...
        await DataService.Instance.UpdateCurrentUserProfileAsync(CurrentUser, CurrentPassword, NewPassword);
