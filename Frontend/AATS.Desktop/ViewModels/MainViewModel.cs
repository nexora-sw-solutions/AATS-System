...
public partial class MainViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private TeamMember _currentUser = null!;
    ...
    private void InitializeSearchItems()
    {
        _allModules = new List<ModuleSearchItem>
        {
            ...
            new() { Name = "Team", Route = "/team", Category = "Main", Command = NavigateToTeamCommand },
            new() { Name = "Activity Log", Route = "/activity-log", Category = "Main", Command = NavigateToActivityLogCommand },
    ...
    private void NavigateToTaxOthers()
    {
        ...
        vm.NavigateToAddRecord = NavigateToTaxOthersAddRecord;
        NavigateTo(vm, "Tax Filing", "Others", activePage: "TaxOthers");
    }

    [RelayCommand]
    private void NavigateToTaxOthersAddRecord()
    {
        var vm = CurrentView as TaxOthersViewModel ?? new TaxOthersViewModel();
        vm.NavigateToAddRecord = NavigateToTaxOthersAddRecord;
        
        var addVm = new TaxOthersAddRecordViewModel();
        addVm.GoBack = async () => 
        {
            await vm.LoadDataAsync();
            GoBackCommand.Execute(null);
        };
        NavigateTo(addVm, "Tax Filing", "Others", "Add Record", "TaxOthers");
    }
    ...
    private void UpdateProfile()
    {
        ...
        {
            // In a real app we'd show a validation message. 
        ...
        LogService.Instance.AddLog("Update", "Profile", CurrentUser.Branch ?? "Central", 
            $"User '{CurrentUser.Username}' updated their profile details.");
