...
namespace AATS.Desktop.Data
{
    public static class MockData
    {
        ...
        public static List<TeamMember> TeamMembers { get; } = new()
        {
            ...
            new TeamMember { Id = "TM-004", Username = "Suresh Fernando", Email = "suresh@aats.com", Phone = "+94 76 456 7890", Branch = "Northeast", Role = "Staff", CreatedAt = new DateTime(2024, 4, 5) },
            new TeamMember { Id = "TM-005", Username = "Dilshan Jayasuriya", Email = "dilshan@aats.com", Phone = "+94 78 567 8901", Branch = "Central", Role = "Staff", CreatedAt = new DateTime(2024, 5, 12) },
            ...
            new TeamMember { Id = "TM-007", Username = "Ruwan Kumara", Email = "ruwan@aats.com", Phone = "+94 75 789 0123", Branch = "West", Role = "Staff", CreatedAt = new DateTime(2024, 7, 22) },
            new TeamMember { Id = "TM-008", Username = "Tharindu Gamage", Email = "tharindu@aats.com", Phone = "+94 72 890 1234", Branch = "Northeast", Role = "Staff", CreatedAt = new DateTime(2024, 8, 30) },
            new TeamMember { Id = "TM-009", Username = "Nadeeka Wijesinghe", Email = "nadeeka@aats.com", Phone = "+94 77 901 2345", Branch = "Central", Role = "Staff", CreatedAt = new DateTime(2024, 9, 14) },
            new TeamMember { Id = "TM-010", Username = "Isuru Madushan", Email = "isuru@aats.com", Phone = "+94 71 012 3456", Branch = "South", Role = "Staff", CreatedAt = new DateTime(2024, 10, 5) },
            new TeamMember { Id = "TM-011", Username = "Gayani Perera", Email = "gayani@aats.com", Phone = "+94 70 123 4567", Branch = "West", Role = "Staff", CreatedAt = new DateTime(2024, 11, 10) },
            new TeamMember { Id = "TM-012", Username = "Kelum Sampath", Email = "kelum@aats.com", Phone = "+94 76 234 5678", Branch = "Central", Role = "Staff", CreatedAt = new DateTime(2024, 12, 1) },
            new TeamMember { Id = "TM-013", Username = "Malith Cooray", Email = "malith@aats.com", Phone = "+94 78 345 6789", Branch = "Northeast", Role = "Staff", CreatedAt = new DateTime(2025, 1, 5) },
        };

        public static List<ClientRecord> Clients { get; } = new()
        {
            new ClientRecord { Id = "CLT-001", Name = "Titan Industries", Email = "titan.industries@example.com", Phone = "+91 77 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 1250000m, DueAmount = 59200m, Status = "Active", Date = DateTime.Now },
            new ClientRecord { Id = "CLT-002", Name = "Astra Finance", Email = "info@astrafinance.com", Phone = "+94 71 XXX XXXX", Branch = "South", Category = "Corporate", TotalRevenue = 2500000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddDays(-1) },
            new ClientRecord { Id = "CLT-003", Name = "Ember Logistics", Email = "info@emberlogistics.com", Phone = "+91 11 XXX XXXX", Branch = "West", Category = "Corporate", TotalRevenue = 4500000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddDays(-3) },
            new ClientRecord { Id = "CLT-004", Name = "Solar Systems", Email = "info@solarsystems.lk", Phone = "+94 11 XXX XXXX", Branch = "Northeast", Category = "Corporate", TotalRevenue = 8500000m, DueAmount = 500000m, Status = "Active", Date = DateTime.Now.AddDays(-10) },
            new ClientRecord { Id = "CLT-005", Name = "Velvet Retail", Email = "info@velvetretail.lk", Phone = "+94 71 XXX XXXX", Branch = "South", Category = "Corporate", TotalRevenue = 6200000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddMonths(-1) },
            new ClientRecord { Id = "CLT-006", Name = "Evolve Systems", Email = "info@evolvesystems.lk", Phone = "+94 76 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 950000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddMonths(-2) },
            new ClientRecord { Id = "CLT-007", Name = "Prism Retail", Email = "info@prismretail.lk", Phone = "+94 75 XXX XXXX", Branch = "West", Category = "SME", TotalRevenue = 600000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddMonths(-5) },
            new ClientRecord { Id = "CLT-008", Name = "Orbit Logistics", Email = "info@orbitlogistics.lk", Phone = "+94 91 XXX XXXX", Branch = "Northeast", Category = "SME", TotalRevenue = 350000m, DueAmount = 0, Status = "Inactive", Date = DateTime.Now.AddYears(-1) },
            new ClientRecord { Id = "CLT-009", Name = "Bridge Partners", Email = "info@bridgepartners.lk", Phone = "+94 21 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 2800000m, DueAmount = 500000m, Status = "Active", Date = DateTime.Now.AddYears(-2) },
            new ClientRecord { Id = "CLT-010", Name = "Zenith Tech", Email = "info@zenithtech.lk", Phone = "+94 77 XXX XXXX", Branch = "South", Category = "SME", TotalRevenue = 1500000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddYears(-3) },
            new ClientRecord { Id = "CLT-011", Name = "Nexus Global", Email = "info@nexusglobal.lk", Phone = "+94 71 XXX XXXX", Branch = "West", Category = "Corporate", TotalRevenue = 12000000m, DueAmount = 2500000m, Status = "Active", Date = DateTime.Now.AddDays(-5) },
            new ClientRecord { Id = "CLT-012", Name = "Quantum Solutions", Email = "info@quantum.lk", Phone = "+94 76 XXX XXXX", Branch = "Northeast", Category = "SME", TotalRevenue = 850000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddMonths(-3) },
            new ClientRecord { Id = "CLT-013", Name = "Apex Logistics", Email = "info@apex.lk", Phone = "+94 11 XXX XXXX", Branch = "Central", Category = "Corporate", TotalRevenue = 3300000m, DueAmount = 0, Status = "Active", Date = DateTime.Now.AddYears(-1).AddMonths(-2) },
        };
        ...
        public static Dictionary<string, List<AuditRecord>> AuditRecords { get; } = new()
        {
            ...
            ["BOI"] = new()
            {
                ...
                { 
                    ...
                    Assignment = "BOI Registration",
                    CurrentStep = 1,
                    SourceDocuments = new()
                    {
                        new SourceDocument { FileName = "BR_Stark.pdf", Description = "Business Registration" }
                    }
                },
                new AuditRecord { ID = "BOI-002", Date = new DateTime(2024, 02, 15), ClientName = "Bruce Wayne", Company = "Wayne Enterprises", Country = "USA", Branch = "West" },
                new AuditRecord { ID = "BOI-003", Date = new DateTime(2024, 02, 20), ClientName = "Steve Rogers", Company = "Shield Logistics", Country = "USA", Branch = "Central" },
                new AuditRecord { ID = "BOI-004", Date = new DateTime(2024, 02, 25), ClientName = "Peter Parker", Company = "Daily Bugle", Country = "USA", Branch = "Northeast" },
                new AuditRecord { ID = "BOI-005", Date = new DateTime(2024, 03, 01), ClientName = "Natasha Romanoff", Company = "Black Widow Security", Country = "Russia", Branch = "South" },
                new AuditRecord { ID = "BOI-006", Date = new DateTime(2024, 03, 05), ClientName = "Thor Odinson", Company = "Asgard Exports", Country = "Norway", Branch = "West" },
                new AuditRecord { ID = "BOI-007", Date = new DateTime(2024, 03, 10), ClientName = "Wanda Maximoff", Company = "WandaVision Props", Country = "Sokovia", Branch = "Central" },
                new AuditRecord { ID = "BOI-008", Date = new DateTime(2024, 03, 15), ClientName = "Stephen Strange", Company = "Sanctum Solutions", Country = "USA", Branch = "Northeast" },
                new AuditRecord { ID = "BOI-009", Date = new DateTime(2024, 03, 20), ClientName = "T'Challa", Company = "Wakanda Tech", Country = "Wakanda", Branch = "South" },
                new AuditRecord { ID = "BOI-010", Date = new DateTime(2024, 03, 25), ClientName = "Carol Danvers", Company = "Starforce Travels", Country = "USA", Branch = "West" },
            },
