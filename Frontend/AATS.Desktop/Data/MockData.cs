...
namespace AATS.Desktop.Data
{
    public static class MockData
    {
        ...
        {
            new ClientRecord { Id = "CLT-001", Name = "Titan Industries", Email = "titan.industries@example.com", Phone = "+91 77 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 1250000m, DueAmount = 59200m, Status = "Active" },
            new ClientRecord { Id = "CLT-002", Name = "Astra Finance", Email = "info@astrafinance.com", Phone = "+94 71 XXX XXXX", Branch = "South", Category = "Corporate", TotalRevenue = 2500000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-003", Name = "Ember Logistics", Email = "info@emberlogistics.com", Phone = "+91 11 XXX XXXX", Branch = "West", Category = "Corporate", TotalRevenue = 4500000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-004", Name = "Solar Systems", Email = "info@solarsystems.lk", Phone = "+94 11 XXX XXXX", Branch = "Northeast", Category = "Corporate", TotalRevenue = 8500000m, DueAmount = 500000m, Status = "Active" },
            new ClientRecord { Id = "CLT-005", Name = "Velvet Retail", Email = "info@velvetretail.lk", Phone = "+94 71 XXX XXXX", Branch = "South", Category = "Corporate", TotalRevenue = 6200000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-006", Name = "Evolve Systems", Email = "info@evolvesystems.lk", Phone = "+94 76 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 950000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-007", Name = "Prism Retail", Email = "info@prismretail.lk", Phone = "+94 75 XXX XXXX", Branch = "West", Category = "SME", TotalRevenue = 600000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-008", Name = "Orbit Logistics", Email = "info@orbitlogistics.lk", Phone = "+94 91 XXX XXXX", Branch = "Northeast", Category = "SME", TotalRevenue = 350000m, DueAmount = 0, Status = "Inactive" },
            new ClientRecord { Id = "CLT-009", Name = "Bridge Partners", Email = "info@bridgepartners.lk", Phone = "+94 21 XXX XXXX", Branch = "Central", Category = "SME", TotalRevenue = 2800000m, DueAmount = 500000m, Status = "Active" },
            new ClientRecord { Id = "CLT-010", Name = "Zenith Tech", Email = "info@zenithtech.lk", Phone = "+94 77 XXX XXXX", Branch = "South", Category = "SME", TotalRevenue = 1500000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-011", Name = "Nexus Global", Email = "info@nexusglobal.lk", Phone = "+94 71 XXX XXXX", Branch = "West", Category = "Corporate", TotalRevenue = 12000000m, DueAmount = 2500000m, Status = "Active" },
            new ClientRecord { Id = "CLT-012", Name = "Quantum Solutions", Email = "info@quantum.lk", Phone = "+94 76 XXX XXXX", Branch = "Northeast", Category = "SME", TotalRevenue = 850000m, DueAmount = 0, Status = "Active" },
            new ClientRecord { Id = "CLT-013", Name = "Apex Logistics", Email = "info@apex.lk", Phone = "+94 11 XXX XXXX", Branch = "Central", Category = "Corporate", TotalRevenue = 3300000m, DueAmount = 0, Status = "Active" },
        };
