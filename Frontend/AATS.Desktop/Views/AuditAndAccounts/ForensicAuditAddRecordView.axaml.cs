...
public partial class ForensicAuditAddRecordView : UserControl
{
    public ForensicAuditAddRecordView()
    {
        InitializeComponent();
    }
    ...
    protected override void OnAttachedToVisualTree(Avalonia.VisualTreeAttachmentEventArgs e)
    {
        ...
        if (DataContext is ViewModels.AuditAndAccounts.ForensicAuditAddRecordViewModel vm)
        {
            ...
            vm.RequestFilePicker = async () =>
            {
                ...
                var files = await topLevel.StorageProvider.OpenFilePickerAsync(new Avalonia.Platform.Storage.FilePickerOpenOptions
                {
                    Title = "Select Forensic Case Documents",
                    AllowMultiple = true
                });
