...
{
    public partial class InternalAuditAddRecordViewModel : ViewModelBase
    {
        ...
        public InternalAuditAddRecordViewModel() 
        {
            _ = LoadClientCodesAsync(); 
        }

        // Constructor for editing existing records (pre-fill fields)
        public InternalAuditAddRecordViewModel(AuditRecord record)
        {
            _ = LoadClientCodesAsync();
        ...
        private void SaveRecord()
        {
            ...
            ConfirmSaveMessage = _originalRecord != null 
                ...
                : "Are you sure you want to create this new internal audit record?";
        ...
        private async System.Threading.Tasks.Task ConfirmSave()
        {
            ...
            try 
            {
                ...
                if (_originalRecord != null)
                {
                    ...
                    _originalRecord.PartialAmount = (PaymentStatus == "Paid") ? TotalPayment : (PaymentStatus == "Partial" ? TotalPayment / 2 : 0); // Simplified logic
                    
                    await DataService.Instance.UpdateAuditRecordAsync("Internal Audit", _originalRecord);
                }
                else
                {
                    var newRecord = new AuditRecord
                    {
                        ...
                        Process = "REPORTING", // Default for internal audit
                        CurrentStep = 1
                    };
                    
                    await DataService.Instance.AddAuditRecordAsync("Internal Audit", newRecord);
                }
            } 
            catch (Exception ex) 
            {
