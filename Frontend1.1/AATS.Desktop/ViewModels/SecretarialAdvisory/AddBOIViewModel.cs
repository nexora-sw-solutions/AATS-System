...
public partial class AddBOIViewModel : ViewModelBase
{
    ...
    private async System.Threading.Tasks.Task ConfirmSave()
    {
        ...
        if (_originalRecord != null)
        {
            ...
            {
                _originalRecord.SourceDocuments.Add(new SourceDocument { FileName = file, Description = "BOI Document" });
            }
        ...
        else
        {
            ...
            foreach (var file in UploadedFiles)
            {
                newRecord.SourceDocuments.Add(new SourceDocument { FileName = file, Description = "BOI Document" });
            }
